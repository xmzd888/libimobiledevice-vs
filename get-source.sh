git clone --single-branch --branch msvc/master https://github.com/xmzd888/libplist
git clone --single-branch --branch msvc/master https://github.com/libimobiledevice-win32/libusbmuxd
git clone --single-branch --branch msvc/master https://github.com/xmzd888/libimobiledevice
